...
{
    int *start_filter_arr = malloc(sizeof(int) * 3);
    int *end_filter_arr = start_filter_arr + 3;
...
{
    int *start_filter_arr = malloc(sizeof(int) * 4);
    int *end_filter_arr = start_filter_arr + 4;
...
{
    int *start_filter_arr = malloc(sizeof(int) * 2);
    int *end_filter_arr = start_filter_arr + 2;
